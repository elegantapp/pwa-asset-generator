# pwa-asset-generator ✨
[![npm](https://img.shields.io/npm/v/pwa-asset-generator?color=brightgreen)](https://www.npmjs.com/package/pwa-asset-generator) [![npm downloads](https://img.shields.io/npm/d18m/pwa-asset-generator)](https://npm-stat.com/charts.html?package=pwa-asset-generator&from=2019-01-29) [![node](https://img.shields.io/node/v/pwa-asset-generator)](https://www.npmjs.com/package/pwa-asset-generator) [![Build Status](https://github.com/elegantapp/pwa-asset-generator/actions/workflows/ci.yml/badge.svg?branch=master)](https://github.com/elegantapp/pwa-asset-generator/actions?workflow=CI) [![semantic-release](https://img.shields.io/badge/%20%20%F0%9F%93%A6%F0%9F%9A%80-semantic--release-brightgreen.svg)](https://github.com/semantic-release/semantic-release) [![open-collective](https://img.shields.io/opencollective/all/pwa-asset-generator)](https://opencollective.com/pwa-asset-generator/donate)
...
- **Node.js** `>=22.12.0` ([puppeteer-core](https://www.npmjs.com/package/puppeteer-core) v25's floor)
...
pwa-asset-generator uses a [js-beautify](https://www.npmjs.com/package/js-beautify)-derived HTML beautifier (via its own `html-format` helper) for formatting your index.html file with a simple, opinionated output.
