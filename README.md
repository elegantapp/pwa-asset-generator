...
- **Node.js** `>=22.12.0` ([puppeteer-core](https://www.npmjs.com/package/puppeteer-core) v25's floor; `js-beautify`'s `nopt`/`abbrev` dependencies are pinned via `overrides` to versions that support this range)
